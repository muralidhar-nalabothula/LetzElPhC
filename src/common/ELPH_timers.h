 ...
 * 
 * Provides functions for measuring and reporting execution times of code sections.
 * Timers are identified by string names and support multiple start/stop cycles
 * with automatic accumulation and counting.
 * 
 * Typical usage:
 * @code
 * init_ELPH_clocks();
